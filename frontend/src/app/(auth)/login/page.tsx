...
// ─── GitHub Icon (inline SVG — lucide-react removed this) ───────
...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("demo@devmarket.dev");
      ...
      <div className="w-full max-w-sm">
        ...
        ">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-xs text-text-muted">or use demo account</span>
            <div className="flex-1 h-px bg-white/[0.08]" />
          </div>
          ...
          <form onSubmit={handleDemoLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="demo@devmarket.dev"
                required
                className="
                  w-full h-10 px-3
                  bg-white/[0.04] border border-white/[0.08]
          ...
          <p className="text-[10px] text-text-muted text-center mt-6">
            Demo login uses credentials provider for local development.
            <br />
            Configure GitHub/Google OAuth in .env.local for production.
          </p>
        </div>
      </div>
    </div>
